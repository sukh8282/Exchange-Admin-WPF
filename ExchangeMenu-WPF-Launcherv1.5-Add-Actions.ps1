...
function Set-RowCount($items){ ... }
function Set-Elapsed([TimeSpan]$span){ ... }
function Set-LastAction([string]$name){ ... }
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Window.Resources>
    <SolidColorBrush x:Key="AppBg"      Color="#FAFBFD"/>
    <SolidColorBrush x:Key="PanelBg"    Color="#FFFFFF"/>
    <SolidColorBrush x:Key="BorderClr"  Color="#DDE3EE"/>
    <SolidColorBrush x:Key="AltRowClr"  Color="#FFF5F5F5"/>
  ...
  <DockPanel>
    ...
    <Menu DockPanel.Dock="Top">
      <MenuItem Header="_File">
        ...
        <Separator/>
        <MenuItem Header="_Import CSV to Grid" x:Name="MnuImportCsv"/>
      ...
      <MenuItem Header="_View">
        ...
        <MenuItem Header="_Theme">
          <MenuItem Header="_Light" x:Name="MnuThemeLight" IsCheckable="True" IsChecked="True"/>
          <MenuItem Header="_Dark"  x:Name="MnuThemeDark"  IsCheckable="True"/>
        </MenuItem>
      </MenuItem>
    ...
    <StatusBar DockPanel.Dock="Bottom" Height="24" Background="#F3F6FB">
      <StatusBarItem>
        <TextBlock x:Name="SbStatus" Text="Ready"/>
      </StatusBarItem>
      <Separator/>
      <StatusBarItem>
        <TextBlock x:Name="SbRows" Text="Rows: 0"/>
      </StatusBarItem>
      <Separator/>
      <StatusBarItem>
        <TextBlock x:Name="SbElapsed" Text="Elapsed: 0 ms"/>
      </StatusBarItem>
      <Separator/>
      <StatusBarItem>
        <TextBlock x:Name="SbLastAction" Text="Last: —"/>
      </StatusBarItem>
    </StatusBar>
...
$mnuImportCsv  = $win.FindName("MnuImportCsv")
$mnuThemeLight = $win.FindName("MnuThemeLight")
$mnuThemeDark  = $win.FindName("MnuThemeDark")
$sbStatus   = $win.FindName("SbStatus")
$sbRows     = $win.FindName("SbRows")
$sbElapsed  = $win.FindName("SbElapsed")
$sbLast     = $win.FindName("SbLastAction")
...
$mnuImportCsv.Add_Click({ Import-CsvToGrid })
$mnuThemeLight.Add_Click({ Apply-Theme 'Light' })
$mnuThemeDark.Add_Click({ Apply-Theme 'Dark' })
